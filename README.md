...
### Команда /shop
![Магазин Fortnite](./images/shop_command.png)

### Команда /random
![Случайный предмет](./images/random_command.png)
...
Этот проект демонстрирует, как создать полезное приложение с интеграцией внешних API и удобным интерфейсом в Telegram. Может быть полезен игрокам и разработчикам, изучающим работу с API.
